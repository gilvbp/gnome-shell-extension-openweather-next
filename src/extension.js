...
export default class OpenWeatherExtension extends Extension {
    ...
    constructor(metadata) {
        ...
        let openWeatherExtension = this;
        this.OpenWeatherMenuButton = GObject.registerClass(
            class OpenWeatherMenuButton extends PanelMenu.Button {
                ...
                loadConfig() {
                    this._settings = openWeatherExtension.getSettings();
                ...
                loadConfigInterface() {
                    this._settingsInterface = openWeatherExtension.getSettings('org.gnome.desktop.interface');
    ...
    enable() {
        openWeatherMenu = new this.OpenWeatherMenuButton();
